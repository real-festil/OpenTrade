              ...
              {this.state.treeShow ? (
                <>
                  <div className={classes.SubTree}>
                    <Treeview
                      clicked={this.onSubTreeClicked}
                      caption="intraday pnls"
                    >
                        ...
                        <div>
                          ...
                          <li
                            onClick={() =>
                              this.addTableHandler(
                                "dayPnlsRealized",
                                "template|interday pnls|realized"
                              )
                            }
                          >
                            realized
                          ...
                          <li
                            onClick={() =>
                              this.addTableHandler(
                                "dayPnlsUnrealized",
                                "template|interday pnls|unrealized"
                              )
                            }
                          >
                            unrealized
