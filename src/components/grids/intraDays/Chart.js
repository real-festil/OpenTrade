	...
	render() {
        ...
        xExtents={xExtents}
			>
				...
				>
					<XAxis axisAt="bottom" orient="bottom" showTicks={false} stroke={this.props.isDark ? "#FFFFFF" : "black"} outerTickSize={0} tickStroke={this.props.isDark ? "#FFFFFF" : "black"}/>
					<YAxis axisAt="right" orient="right" ticks={5} stroke={this.props.isDark ? "#FFFFFF" : "black"} tickStroke={this.props.isDark ? "#FFFFFF" : "black"}/>
     ...
     <OHLCTooltip origin={[-40, 0]}
                  labelFill={this.props.isDark ? "yellow" : null}
                  textFill={this.props.isDark ? "#FFFFFF" : null}/>
      ...
      textFill={this.props.isDark ? "#FFFFFF" : null}
        ...
        windowSize: ema12.options().windowSize,
				...
				<Chart id={2} height={150}
					...
					origin={(w, h) => [0, h - 300]}
				>
					<YAxis axisAt="left" orient="left" ticks={5} tickFormat={format(".2s")} tickStroke={this.props.isDark ? "#FFFFFF" : "black"}/>
				...
				>
					<XAxis axisAt="bottom" orient="bottom" stroke={this.props.isDark ? "#FFFFFF" : "black"} tickStroke={this.props.isDark ? "#FFFFFF" : "black"}/>
					<YAxis axisAt="right" orient="right" ticks={2} stroke={this.props.isDark ? "#FFFFFF" : "black"} tickStroke={this.props.isDark ? "#FFFFFF" : "black"}/>
					<MouseCoordinateX
						at="bottom"
						orient="bottom"
...
const mapStateToProps = (state) => {
 return {
   isDark: state.theme === "dark" || "blue" ? true : false,
   isBlue: state.theme === "blue" ? true : false
 }
}

export default connect(mapStateToProps)(CandleStickChartWithBrush);
